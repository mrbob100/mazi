 ...
 'slider_path'=>'public/pink/images',
  ...
  'galary_path'=>'public/pink/images/galary',
    ...
    'handbook'=>[
        ...
        '39'=>[ 'name'=>'Corp\Models\Accumulatortype'],
        '40'=>[ 'name'=>'Corp\Models\Accuracy'],
        '41'=>[ 'name'=>'Corp\Models\Accuracyslope'],
        '42'=>[ 'name'=>'Corp\Models\Android'],
        '43'=>[ 'name'=>'Corp\Models\Angle'],
        '44'=>[ 'name'=>'Corp\Models\Brightness'],
        '45'=>[ 'name'=>'Corp\Models\Calculation'],
        '46'=>[ 'name'=>'Corp\Models\Chargetime'],
        '47'=>[ 'name'=>'Corp\Models\Containervol'],
        '48'=>[ 'name'=>'Corp\Models\Crownlength'],
        '49'=>[ 'name'=>'Corp\Models\Display'],
        '50'=>[ 'name'=>'Corp\Models\Fixture'],
        '51'=>[ 'name'=>'Corp\Models\Functional'],
        '52'=>[ 'name'=>'Corp\Models\Gluediameter'],
        '53'=>[ 'name'=>'Corp\Models\Gluelength'],
        '54'=>[ 'name'=>'Corp\Models\Goaldistance'],
        '55'=>[ 'name'=>'Corp\Models\Holediameter'],
        '56'=>[ 'name'=>'Corp\Models\Ignition'],
        '57'=>[ 'name'=>'Corp\Models\Iphone'],
        '58'=>[ 'name'=>'Corp\Models\Laserclass'],
        '59'=>[ 'name'=>'Corp\Models\Magnificate'],
        '60'=>[ 'name'=>'Corp\Models\Measurange'],
        '61'=>[ 'name'=>'Corp\Models\Measurenumber'],
        '62'=>[ 'name'=>'Corp\Models\Oscillationangle'],
        '63'=>[ 'name'=>'Corp\Models\Powersupply'],
        '64'=>[ 'name'=>'Corp\Models\Screw'],
        '65'=>[ 'name'=>'Corp\Models\Strokeqnt'],
        '66'=>[ 'name'=>'Corp\Models\Temperature'],
        '67'=>[ 'name'=>'Corp\Models\Thread'],
        '68'=>[ 'name'=>'Corp\Models\Turbinpower'],
        '69'=>[ 'name'=>'Corp\Models\Typeaccuracy'],
        '70'=>[ 'name'=>'Corp\Models\Unit'],
        '71'=>[ 'name'=>'Corp\Models\Wheeldiameter'],
        '72'=>[ 'name'=>'Corp\Models\=Worktime'],
