...
@if($product)
    <div class="new-product">
        ...
        <div class="col-md-5 zoom-grid">
            <div class="flexslider">
                <ul class="slides">
                    ...
                    <li data-thumb="{{asset('public/'.env('THEME'))}}/images/{{$product->img->path}}   ">

                        <div class="thumb-image"> <img src="{{asset('public/'.env('THEME'))}}/images/{{$product->img->path}} " data-imagezoom="true" class="img-responsive" alt="вид анфас" /> </div>
                    </li>
                    <li data-thumb="{{asset('public/'.env('THEME'))}} /images/{{$product->img->mini}}">
                        <div class="thumb-image"> <img src="{{asset('public/'.env('THEME'))}} /images/{{$product->img->mini}}" data-imagezoom="true" class="img-responsive" alt="вид сбоку" /> </div>
                    </li>
        ...
        <div class="col-md-7 dress-info">
            ...
            <script src="{!! asset('public/'.env('THEME')) !!}/js/imagezoom.js"></script>
            <!-- FlexSlider -->
            <script defer src="{!!asset('public/'.env('THEME')) !!}/js/jquery.flexslider.js"></script>
            <script>
                    ...
                    <div class="response">
                        <div class="media response-info">
                            <div class="media-left response-text-left">
                                <a href="{{ asset('#') }}">
                                    <img class="media-object" src="{!!asset('public/'.env('THEME')) !!}/images/icon1.png" alt="вывод 1" />
                                </a>
                        ...
                        <div class="media response-info">
                            <div class="media-left response-text-left">
                                <a href="{{ asset('#') }}">
                                    <img class="media-object" src="{!!asset('public/'.env('THEME')) !!}/images/icon1.png" alt="output 2" />
                                </a>
                                <h5><a href="{{ asset('#') }}">Username</a></h5>
                            </div>
                            <div class="media-body response-text-right">
                        ...
                        <div class="media response-info">
                            <div class="media-left response-text-left">
                                <a href="{{ asset('#') }}">
                                    <img class="media-object"src="{!!asset('public/'.env('THEME')) !!}/images/icon1.png" alt="output 3" />
                                </a>
                                <h5><a href="{{ asset('#') }}">Username</a></h5>
                            </div>
                            <div class="media-body response-text-right">
                        ...
                        <div class="media response-info">
                            <div class="media-left response-text-left">
                                <a href="{{ asset('#') }}">
                                    <img class="media-object" src="{!!asset('public/'.env('THEME')) !!}/images/icon1.png" alt="output 4" />
                                </a>
                                <h5><a href="{{ asset('#') }}">Username</a></h5>
                            </div>
                            <div class="media-body response-text-right">
                        ...
                        <div class="media response-info">
                            <div class="media-left response-text-left">
                                <a href="{{ asset('#') }}">
                                    <img class="media-object" src="{!!asset('public/'.env('THEME')) !!}/images/icon1.png" alt="output 5" />
                                </a>
                                <h5><a href="{{ asset('#') }}">Username</a></h5>
                            </div>
                            <div class="media-body response-text-right">
                        ...
                        <div class="media response-info">
                            <div class="media-left response-text-left">
                                <a href="{{ asset('#') }}">
                                    <img class="media-object" src="{!!asset('public/'.env('THEME')) !!}/images/icon1.png" alt="output 6" />
                                </a>
                                <h5><a href="{{ asset('#') }}">Username</a></h5>
                            </div>
                            <div class="media-body response-text-right">
                        ...
                        <div class="media response-info">
                            <div class="media-left response-text-left">
                                <a href="{{ asset('#') }}">
                                    <img class="media-object" src="{!!asset('public/'.env('THEME')) !!}/images/icon1.png" alt="output 7" />
                                </a>
                                <h5><a href="{{ asset('#') }}">Username</a></h5>
                            </div>
                            <div class="media-body response-text-right">
    ...
    <div class="other-products products-grid">
        <div class="container">
            ...
            <div class="col-md-4 product simpleCart_shelfItem text-center">
                <a href="{{ asset('#') }}"><img src="{!!asset('public/'.env('THEME')) !!}/images/icon1.png" alt="output 8" /></a>
                <div class="mask">
    ...
    <script src="{!!asset('public/'.env('THEME')) !!}/js/responsive-tabs.js"></script>
