<div class="navbar-default sidebar" role="navigation">
    ...
    <div class="sidebar-nav slimscrollsidebar">
        ...
        <ul class="nav" id="side-menu">
            <li class="user-pro">
                <a href="#" class="waves-effect"><img src="{{ asset('public/'.env('THEME')) }}/admin/plugins/images/users/varun.jpg" alt="user-img" class="img-circle"> <span class="hide-menu"> Steve Gection<span class="fa arrow"></span></span>
                </a>
            ...
            <li> <a href="#" class="waves-effect"><i class="mdi mdi-content-copy fa-fw"></i> <span class="hide-menu">Главное меню<span class="fa arrow"></span><span class="label label-rouded label-warning pull-right">30</span></span></a>
                <ul class="nav nav-second-level">
                    ...
                    <li><a href="{{route('loadCsv')}}">"><i class="ti-layout-width-default fa-fw"></i> <span class="hide-menu">Загрузка файлов JSON</span></a></li>
                    <li><a href="{{route('contfile')}}">"><i class="ti-layout-width-default fa-fw"></i> <span class="hide-menu">Смотреть файл ошибок ввода при загрузке JSON</span></a></li>
                    <li><a href="{{route('excelIt')}}">"><i class="ti-layout-width-default fa-fw"></i> <span class="hide-menu">Выгрузка на Hotline</span></a></li>
                    <li>{{link_to('storage/app/public/priceXML.xls')}}</li>
                    <li><a href="{{route('userson',['id'=>2])}}">"><i class="ti-layout-width-default fa-fw"></i> <span class="hide-menu">Работа с менеджерами</span></a></li>
                    ...
                    <li><a href="javascript:void(0)" class="waves-effect"><i class="ti-email fa-fw"></i> <span class="hide-menu">Email Templates</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-third-level">
                            <li> <a href="basic.html"><i class="fa-fw">B</i> <span class="hide-menu">Basic</span></a></li>
                            <li> <a href="alert.html"><i class="ti-alert fa-fw"></i> <span class="hide-menu">Alert</span></a></li>
                            <li> <a href="billing.html"><i class="ti-wallet fa-fw"></i> <span class="hide-menu">Billing</span></a></li>
                            <li> <a href="password-reset.html"><i class="ti-more fa-fw"></i> <span class="hide-menu">Reset Pwd</span></a></li>
                        </ul>
                    </li>
            ...
            <li class="devider"></li>
            <li> <a href="{{ asset('resources/views/'.env('THEME')) }}/admin/commonhtml/widgets.html" class="waves-effect"><i  class="mdi mdi-settings fa-fw"></i> <span class="hide-menu">Widgets</span></a> </li>
