    ...
    <div class="wrap_02">
        ...
        <div class="right_side2" >
            ...
            <!--a href="#"   data-id="{{--$product->id--}}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Купить</a-->
                <a id="reactivebut" href="{{route('addcartios',['id'=>$products[0]->id])}}" data-href="{{URL::to('addcartios')}}" style=" margin-right: 50px" data-id="{{$products[0]->id}}" data-sign="25"> <img src="{{ asset('public/'.env('THEME'))}}/images/features/add.png" alt="вывод кнопки добавить" /></a>
                @if($discount>0)
