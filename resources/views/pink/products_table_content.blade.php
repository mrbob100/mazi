@if($products)
    <div class="sortie">
        ...
        <div class="sortieOption">
            <div class="sortie3" >
                <p>Сортировка</p>
                <select id="sortValue"  onchange="onSorties();">
            ...
            <div class="sortie5" >
                <a id="cascad" href="{{route('category') }}"  data-id="10"><span class="glyphicon glyphicon-th"></span></a>
            </div>
            <div class="sortie5" >
                <a id="cascad" href="{{route('category') }}" data-id="11" ><span class="glyphicon glyphicon-th-list"></span></a>
            </div>
